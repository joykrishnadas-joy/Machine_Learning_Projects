...
loaded_scaler = pickle.load(open("ML Full Project/Custome Churn Prediction (1)/scaler.pkl", "rb"))
loaded_model = pickle.load(open("ML Full Project/Custome Churn Prediction (1)/model.pkl", "rb"))
